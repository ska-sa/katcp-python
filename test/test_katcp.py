...
class TestSensor(unittest.TestCase):
    ...
    def test_sampling(self):
        ...
        katcp.sampling.SampleNone(None, "name", s)
        katcp.sampling.SamplePeriod(None, "name", s, 10)
        katcp.sampling.SampleEvent(None, "name", s)
        katcp.sampling.SampleDifferential(None, "name", s, 2)
        self.assertRaises(ValueError, katcp.sampling.SampleNone, None, "name", s, "foo")
        self.assertRaises(ValueError, katcp.sampling.SamplePeriod, None, "name", s)
        self.assertRaises(ValueError, katcp.sampling.SamplePeriod, None, "name", s, "1.5")
        self.assertRaises(ValueError, katcp.sampling.SamplePeriod, None, "name", s, "-1")
        self.assertRaises(ValueError, katcp.sampling.SampleEvent, None, "name", s, "foo")
        self.assertRaises(ValueError, katcp.sampling.SampleDifferential, None, "name", s)
        self.assertRaises(ValueError, katcp.sampling.SampleDifferential, None, "name", s, "-1")
        self.assertRaises(ValueError, katcp.sampling.SampleDifferential, None, "name", s, "1.5")
